...
namespace WebApplication.Controllers
{
    public class HomeController : Controller
    {
        ...
        private EthereumContractInfo _contractInfo;
        ...
        public async Task<IActionResult> ImportContract(IFormFile file)
        {
            ...
            _contractInfo = new EthereumContractInfo()
            {
                Abi = abi,
                Bytecode = byteCode,
            ...
            _contractInfo.TransactionHash = await _service.ReleaseContract(_contractInfo, gas, fileContent);

            string contractAddress = _service.TryGetContractAddress(_contractInfo).Result.ContractAddress;
            Contract contract = await _service.GetContract(_contractInfo);
